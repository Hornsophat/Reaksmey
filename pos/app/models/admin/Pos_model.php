...
class Pos_model extends CI_Model
{
    ...
    public function bills_count()
    {
        ...
        if (!$this->Owner && !$this->Admin) {
            $sus=$this->db->get_where('suspended_bills',  array('date' => $date));
        }
        return $sus;
    }
    ...
    function get_updateTransfer($f_id,$t_id){
        // var_dump($f_id);die();
        if ($f_id != '' && $t_id != '') {
           $t_up = $this->db->where('suspend_id',$f_id)->update('suspended_items',array('suspend_id'=>$t_id,'transfer_table_id'=>$f_id));
           if ($t_up) {
