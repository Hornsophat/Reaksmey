    ...
    function permissions($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'reports-register_report' =>$this->input->post('register_report'),
                'reports-stock_in_out_report' =>$this->input->post('stock_in_out_report'), 
                'reports-warehouse_chat' => $this->input->post('warehouse_chat'),
                'reports-profit_and_loss' => $this->input->post('profit_and_loss'),
                'account_receivable' => $this->input->post('account_receivable'), 
                'account_payable' => $this->input->post('account_payable'),
                'add-purchases-expenses' =>$this->input->post('add-purchases-expenses'),
                'sum_purchases_payment' => $this->input->post('sum_purchases_payment'),
                'list_purchases_payment' => $this->input->post('list_purchases_payment')      
