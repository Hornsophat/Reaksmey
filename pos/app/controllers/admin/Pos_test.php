...
class Pos extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $serial = str_replace("(","",str_replace(")","",$this->GetVolumeLabel("D")));

        //echo $serial; die();
        // if(trim($serial)!='D8C1-FFD7'){
    ...
    public function view($sale_id = NULL, $modal = NULL)
    {
        ...
        // var_dump($this->data['currency']);die();
    ...
    public function opened_bills($per_page = 0)
    {
        ...
        if (!empty($bills)) {
            ...
            foreach ($bills as $bill) {
                ...
                // <br>'.lang('total').': ' . $this->sma->formatMoney($bill->total) . '</button></li>';
                ...
                $html .= '<p class="hide">' . $bill->suspend_note . '</p>
                          ...
                          <p class="">Total: R' . $this->sma->formatMoney($total->subtotal) . '</p>';
    ...
    function do_print_receipt(){
        ...
        try {
            /* Set up command */
            $source = "assets/php_print/output/rec.jpg";
            /* Load up the image */
            try{
