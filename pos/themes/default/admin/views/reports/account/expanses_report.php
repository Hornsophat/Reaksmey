      ...
      <div class="col-sm-12">
        <div class="row">
          <div class="col-sm-10 pull-right" style="text-align: right;">
            <form class="form-inline" role="form" method="get" action="<?php echo site_url('admin/reports/expanses_report');?>">
          ...
          <table class="table table-bordered" style=" border-left: none;">
            ...
            foreach ($getrp as $filter_report) {
              ...
              <tr>
                ...
                <td  align="right"><?php echo number_format($filter_report->grand_total,2) ?></td>
              </tr>
              <?php } ?>
              <tr >
