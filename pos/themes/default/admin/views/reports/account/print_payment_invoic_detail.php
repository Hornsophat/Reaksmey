                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <th><?php echo $this->sma->formatMoney($det_re->unit_cost);?>(R)</th>
                                <td><?php echo $this->sma->formatMoney($total_usd) ?>(R)</td>
                    ...
                    <table class="table table-bordered" style="background: white !important">
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:right; padding-right:10px 0px;font-weight:bold;"><?= number_format($total_am /$rate->rate,2); ?>&nbsp;(USD)</td>
                                <td style="text-align:right; padding-right:10px 0px;font-weight:bold;"><?php echo $this->sma->formatMoney($total_am); ?>&nbsp;(R)</td>
                            </tr>
                            <tr class="hide">
