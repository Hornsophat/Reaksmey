...
<head>
    ...
    <title><?php echo $this->lang->line("Payment Reports") . " " . $inv->reference_no; ?></title>
                     ...
                     <div class="well well-sm" style="margin-bottom:0px; background: white !Important;">
                        ...
                        <table class='boldtable' style="background: white !Important; ">
                                ...
                                <tr>
                                    ...
                                    <td  width="10"></td>
                                    <td  align="left"><?php echo $pay_re_det[0]->reference_no; ?></td>
                                </tr>
                              
                                <tr >
                                    <td align="left">កាលបរិច្ឆេទ </td>
                                    <td width="10"></td>
                                    <td align="left"><?= $this->sma->hrld($pay_re_det[0]->date) ?></td>
                                </tr>
                            ...
                            <div class="col-xs-12 text-right"  style="padding-left:0px; padding-right:0px;">
                                <table class='boldtable'>
                                    ...
                                    <tr >
                                        ...
                                        <td width="10"></td>
                                        <td align="left"><?php echo $pay_re_det[0]->company; ?></td>
                                    </tr>
                                    <tr>
                                        <td align="left">លេខទូរស័ព្ទ</td>
                                        <td width="10"></td>
                                        <td align="left"><?= $pay_re_det[0]->phone; ?></td>
                                    </tr>
                                    
                                    <tr>
                                        <td style="padding-bottom: 5px;" align="left">អាស័យដ្ឋាន</td>
                                        <td style="padding-bottom: 5px;" width="10"></td>
                                        <td style="padding-bottom: 5px;" align="left"><?= $pay_re_det[0]->address ; ?></td>
                                    </tr> 
                                </table>
                ...
                <table class="table table-bordered table-hover table-striped" style="background: white !important; margin: 0px !important">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $remain=0;
                            $i=0;
                            foreach ($pay_re_det as $det_re): $i++;
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><a target="_black" href="<?php echo base_url('admin/reports/payment_invoice_report_det/'.$det_re->purchase_id);?>"><?php echo $det_re->purchase_id ?></a></td>    
                                ...
                                <th><?php echo $this->sma->formatMoney($total_usd);?>(R)</th>
                                <th><?php echo $this->sma->formatMoney($det_re->paid);?>(R)</th>
                                <td><?php echo $this->sma->formatMoney($total_remain); ?>(R)</td>
                                <!-- <td><?php echo $this->sma->formatMoney($total_usd*$rate->rate)?>(R)</td> -->
                                <!-- <td><?php //echo $this->sma->formatMoney($vd->total - $vd->amount_usd) ?>(USD)</td> -->
                            </tr>
                        <?php endforeach ?>
                            <tr>
                                <td colspan="3" align="right">Total Amoun</td>
                                <td align="right"><?php echo $this->sma->formatMoney($total_am);?>(R)</td>
                                <td align="right"><?php echo $this->sma->formatMoney($total_paid);?>(R)</td>
                                <td align="right"><?php echo $this->sma->formatMoney($remain);?>(R)</td>
                            </tr>
                    ...
                    <table class="table table-bordered" style="background: white !important">
                        <tbody class="hide">
                            <tr>
                                ...
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= $this->sma->formatMoney($total_am); ?>&nbsp;(R)</td>
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?php echo $this->sma->formatMoney($total_am*$rate->rate); ?>&nbsp;(R)</td>
                            </tr>
                            <tr>
                                <td style="text-align:left  ; padding-right:10px; font-weight:bold;">សរុប/ប្រាក់ខ្វះ</td>
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= $this->sma->formatMoney($remain);?>&nbsp;(R)</td>
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= $this->sma->formatMoney($remain*$rate->rate);?>&nbsp;(R)</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
