                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <li id="sales_sale_by_csv" class="hide">
                                     ...
                                     <!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
                                    <li id="list_suspend">
                                        <a class="submenu" href="<?= admin_url('sales/list_suspend'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('List_Suspend'); ?></span>
                                        </a>
                                    </li>
                                    <!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    ...
    <!-- ====================edit report======================================= -->
                        <li class="report">
                            ...
                            <ul>
                               ...
                               <li id="reports_purchase_items">
                                   <a href="<?php echo base_url('admin/reports/purchase_items');?>">
                                       <i class="fa fa-building"></i><span><?= lang('Purchases_Items_Report');?></span>
                                   </a>
                               </li>
                               <li id="sales_report">
                               ...
                               <li id="usersales_report">
                                   <a href="<?php echo base_url('admin/reports/userDailysale');?>">
                                       <i class="fa fa-barcode"></i><span><?= lang('User Daily Sale');?></span>
                                   </a>
                               </li>
                               ...
                               <li id="account_pay">
                                 ...
                                 <li id="account_pay">
                                       <a href="<?php echo base_url('admin/reports/cash_flow');?>">
                                           <i class="fa fa-money"></i><span><?= lang('Profit_Peport');?></span>
                                       </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <?php
                            ...
                            <?php } ?>
                              ...
                              <?php if ($GP['reports-register_report'] || $GP['reports-daily_sales'] || $GP['reports-expenses'] || $GP['reports-purchases'] || $GP['reports-sales'] || $GP['reports-products'] ||$GP['reports-warehouse_chat'] || $GP['reports-profit_and_loss']) { ?>
                                ...
                                <?php } ?>
                                <?php if ($GP['reports-usersales']) { ?>
                                   <li id="usersales_report">
                                       <a href="<?php echo admin_url('reports/userDailysale');?>">
                                           <i class="fa fa-barcode"></i><span><?= lang('User Daily Sale');?></span>
                                       </a>
                                   </li>
                                <?php } ?>
                                ...
                                <?php } ?>
                                 <?php 
                                    if ($GP['reports-user_daily_sales']) {
                                ?>
                                    <li id="user-daily_salesheader">
                                       <a href="<?php echo base_url('admin/reports/userDailysale');?>">
                                           <i class="fa fa-barcode"></i><span><?= lang('User Daily Sale');?></span>
                                       </a>
                                   </li>
