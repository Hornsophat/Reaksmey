...
<div id="wrap">
    <div class="row">
            ...
            <H2 class="text-center" style="margin-top:-10px;">វិក្កយបត្រ​</H2>
            ...
            <!-- <div class="table-responsive"> -->
                <table class="table table-bordered table-hover table-striped" style="background: white !important; margin: 0px !important">
                    ...
                    <tr>
                        ...
                        <th><?php echo "កាលបរិច្ឆេទ"; ?></th>
                        <th><?php echo "លេខ Reference"; ?></th>
                        <th><?= "ដុល្លា <br> USD";//lang("no"); ?></th>
                    ...
                    <tbody>
                        <?php $i=0;foreach ($voucher_detail as $vd): $i++;?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->sma->formatMoney($vd->amount_usd/$rate->rate) ?>(USD)</td>
                                <td><?php echo $this->sma->formatMoney($vd->amount_usd)?>(R)</td>
                    ...
                    <table class="table table-bordered" style="background: white !important">
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= $this->sma->formatMoney($voucher->amount_usd/$rate->rate); ?>&nbsp;(USD)</td>
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?php echo number_format($voucher->amount_usd,2); ?>&nbsp;(R)</td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= $this->sma->formatMoney($remain_r);?>&nbsp;(R)</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
