...
<script>
    $(document).ready(function () {
        var cTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('customers/get_table') ?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('customers/add_table'); ?>" data-toggle="modal" data-target="#myModal" id="add">
                        ...
                        <li>
                            <a href="#" class="bpo" title="<b><?= $this->lang->line("delete_customers") ?></b>" 
                                ...
                                <i class="fa fa-trash-o"></i> <?= lang('delete_table') ?>
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th class="hide"><?= lang("company"); ?></th>
                            <th ><?= lang("name"); ?></th>
                            <th class=""><?= lang("Location"); ?></th>
                            <th class="hide"><?= lang("phone"); ?></th>
                            <th class="hide"><?= lang("price_group"); ?></th>
                            <th  class="hide"><?= lang("customer_group"); ?></th>
                            <th  class="hide"><?= lang("vat_no"); ?></th>
                            <th class="hide"><?= lang("deposit"); ?></th>
                            <th  class="hide"><?= lang("award_points"); ?></th>
