...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("customers/add_table", $attrib); ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                            <?php   $floor = array('Restaurant'=>'Restaurant','Swimming Pool'=>'Swimming Pool');
                                ...
                                echo form_dropdown('floor',$fl,(isset($_POST['floor'])?$_POST['floor']:''),'class="form-control floor" id="floor"');
                             ?>   
                    </div>
                    <!-- <div class="form-group ">
                        <?= lang("vat_no", "vat_no"); ?>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="email" name="email" required="required" class="form-control" id="email_address"/>
                    </div> -->
                    <div class="form-group hide">
                        <?= lang("phone", "phone"); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_customer', lang('add_table'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
