        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn blightOrange pos-tip" id="transfer_food" title="<span><?=lang('Transfer Food')?></span>" data-placement="bottom" data-html="true" href="<?=admin_url('pos/getTransfer')?>" data-toggle="ajax">
                            <i class="fa fa-eye"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                    ...
                    <div id="leftdiv">
                            ...
                            <div class="no-print">
                                ...
                                <div class="input-group date input-append">
                                  <span class="input-group-addon add-on" style="padding: 1px 10px;"><i class="fa fa-calendar"></i></span>
                                    <input autocomplete="off" type="text" class="form-control " value="<?php echo isset($_GET['last_date']) ? $_GET['last_date'] : date('Y-m-d H:i:s');?>" name="date" class="date_format" id="date" style="width: 100%;" />
                                </div>
                            <?php } ?>
                        ...
                        <div id="print">
                            ...
                            <div id="left-bottom">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-4" style="padding: 0;">
                                            <div class="btn-group-vertical btn-block">
                                                ...
                                                <!-- <a type="button" class="btn btn-info btn-block" id="print_order_receip">
                                                    <?=lang('order');?>
                                                </a>  -->
                                                <button type="button" class="btn btn-primary btn-block" id="print_bill" href="javascript:voice(0)">
                                                    <?=lang('bill');?>
                                                </button>

                                                <!-- <button type="button" class="btn btn-primary btn-block" id="print_bill" href="javascript:voice(0)" onclick="web_print()">
                                                    <?=lang('bill');?>
                                                </button> -->
                                                <!-- <a type="button" class="btn btn-primary btn-block" id="web_print">
                                                    <?=lang('bill');?>
                                                </a> -->
                                            </div>
                                        </div>
                                ...
                                <input type="hidden" name="checkin_id" value="" id="checkin_id">
                                <input type="hidden" name="customer_phone" value="" id="customer_phone">
                                <input type="hidden" name="customer_company" value="" id="customer_company">
...
<div id="brands-slider">
 <div id="floor-list" style="width: 100%">
        <?php 
            foreach ($floors as $frow) {
                echo '<button style="height:50px !important;" type="button" id="floors" class="floors btn-prnisec" value="'.$frow->tbl_location.'">';
                echo '<span>'.$frow->tbl_location.'</span>';
                echo '</button>';
            }
         ?>
    </div>
     <div class="clearfix"></div>
        <div id="sailorTableArea" class="clearfix">
        <thead class="ser_h">
        </thead>
        <tbody class="ser_id">
    <div id="brands_list" style="margin-right: 0px">
       <?php
            foreach ($tables as $table) { 
                ...
                echo '<button style="height:50px !important;" type="button" id="" value="'.$table->id.'" class="'.$btn.' btn-prni ltable">';
                if ($table->image) {
                     echo '<img src="'.site_url('assets/uploads/thumbs/'.$table->image).'" style="width:60px;height:60px;" class="img-rounded img-thumbnail">';
                }else{
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"><i class="fa fa-2x">&times;</i></span>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <!-- <div class="col-sm-4">
                                    <?php 
                                        $sc[''] = 'select customer';
                                        foreach ($cus_new as $crow) {
                                            $sc[$crow->id] = $crow->Family;
                                        }
                                     ?>
                                 <?= form_dropdown('customer_name',$sc,'','class="form-control cusname" id="cusname"') ?>
                                </div> -->
                                <div class="col-sm-4">
                                    <select name="checkin_id" class="form-control checkin_id" id="checkin_id">
                                        <option value="">Select Room</option>
                                        <?php foreach ($HotelRooms as $checkin): ?>
                                            <option cus_id="<?php echo $checkin->customer_id ?>" value="<?php echo $checkin->checkin_id ?>"><?php echo $checkin->room_no ?></option>
                                        <?php endforeach ?>
                                    </select>
                                    <!-- <?php 
                                        $room_arr[] = 'Select Room';
                                        foreach ($HotelRooms as $room) {
                                            $room_arr[$room->checkin_id] = $room->room_no;
                                        }
                                     ?> -->
                                 <!-- <?= form_dropdown('checkin_id',$room_arr,'','class="form-control checkin_id" id="checkin_id"') ?> -->
                                </div>
                                <div class="col-sm-4">
                                    <?= form_input('customer_phone','','readonly class="form-control cus_phone" id="cus_phone" placeholder="Customer Phone"')?>
                                </div>
                                <!-- <div class="col-sm-4">
                                    <?php 
                                        $c_com = ['default'=>'Default'];
                                        $cc['']= '';
                                        foreach ($c_com as $index=>$c_com) {
                                            $cc[$index] = $c_com;

                                        }
                                     ?>
                                    <?= form_dropdown('cus_company',$cc,(isset($_POST['cus_company'])?$_POST['cus_company']:''),'class="form-control cus_company" id="cus_company" placeholder="customer Company"')?>
                                </div> -->
                                <div class="col-sm-4">
                                    
                                    <?= form_input('customer_name','','readonly class="form-control cusname" id="cusname" placeholder="Customer Name"')?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="font16">
                            <table class="table table-bordered table-condensed table-striped" style="margin-bottom: 0;">
                                ...
                                <tr>
                                    ...
                                    <td><span id="total_payable_r">0.00</span><span>(R)</span></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><span id="balance_r">0.00</span><span>(R)</span></td>
                                </tr>
                                </tbody>
                            </table>
                            <div class="clearfix"></div>
...
<div id="order_tblsec" style="display:none;"><span id="order_spansec"></span>
    <table id="order-tablesec" class="prT table table-striped" style="margin-bottom:0;" width="100%;"></table>
</div>
...
<div id="bill_tbl">
  ...
  <div class="col-xs-12 pull-center" style="width:300px; margin:0px !important;padding:0px !important;">
    <div class="col-xs-12 pull-center" style="width:300px;margin-left:0px;margin:0px;padding:0px;margin-top:-40px;">
        <img style="width:300px;height:auto;max-width:100% !important; text-align:center; margin-bottom: -20px;" src="<?php echo base_url();?>/assets/uploads/logos/<?= $biller->logo ?>">
        <p style="text-align: center; width:300px !important;"><?php echo $biller->address;?></p>
        <p style="text-align: center; width:300px !important;"><?php echo $biller->phone;?></p> 
        <p style="text-align: center; width:300px !important;"><?php echo $date= date('Y-m-d H:i:s');?></p>
    </div>
    </div>
  <span id="bill_span"></span>
  <div class="col-md-2 text-left" style="">
   <!-- <label>Date:</label> <?php echo date("Y-m-d H:i:");?> -->
  </div>
  ...
  <table width="100%" class="prT" style="margin-bottom:0;">
    <thead>
    ...
    <tbody id="bill-table" style="line-height:15px !important;" >
    </tbody>
  </table>
  <table  class="prT" style="margin-bottom:0; line-height:20px !important;" width="100%">
    <tr id="bill-total-table" style=" line-height:20px !important;">
    </tr>
  </table>
  ...
  <p style="text-align: center; font-weight: 200; margin-top:0px">***      សូមអគុណ ! សូមអញ្ជើញមកពិសាម្តងទៀត​     ***</p>
</div>
...
<script type="text/javascript">
    $('#cus_phone').empty();
    $(document).on('change','.checkin_id',function(){
        var cus_id = $(".checkin_id option:selected").attr('cus_id');
        // console.log(cus_id);
        // alert(cus_id);
        $.ajax({
            type :'get',
            url  : '<?php echo admin_url()?>pos/getHotelContactDetail/'+cus_id,
            dataType:'Json',
            success:function(data){
                console.log(data);
                if (data) {
                    $('.cus_phone').val(data.Mobile);
                    $('.cus_phone').change();
                    $('#cusname').val(data.Family);
                    $('#cusname').change();
                }
            }
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#print_order_receip').on('click',function(){
            or_print_re();
            ...
            $.post("<?php echo site_url('admin/Pos/save_receipt') ?>", 
                ...
                //if the file saved properly, trigger a popup to the user.
                    if(res != 0){
                        ...
                        // }
                        // alert('res');
                        // setTimeout(function(){ do_print_receipt();}, 6000);
                        do_print_receipt();
                    }
                    else{
    ...
    // ====================second=============================
        ...
        function do_capture_order_html_sec(){
            var ord= $('#order_tblsec');
                ord.addClass('x2');
                div_content = document.querySelector("#order_tblsec")
                var options = {
                    scale:2
                }
                //show data and capture and than hide
                ...
                //make it as html5 canvas
                html2canvas(div_content,options).then(function(canvas2) {
                    //change the canvas to jpeg image
        ...
        function save_imgsec(data){
            console.log(data);
            //ajax method.
            $.post("<?php echo site_url('admin/Pos/save_receiptsec') ?>", 
                {data: data}, 
                function(res){
                //if the file saved properly, trigger a popup to the user.
                    if(res != 0){
        ...
        function do_print_receiptsec(){
            ...
            $.get("<?php echo site_url('admin/Pos/do_print_receiptsec') ?>",
                {printer_name:printer_name},
                function(res){
                    console.log(res);
                });
...
<?php if ($this->session->userdata('remove_posls')) {?>
        ...
        if (localStorage.getItem('checkin_id')) {
            localStorage.removeItem('checkin_id');
        }
        if (localStorage.getItem('cusname')) {
            localStorage.removeItem('cusname');
        }
        if (localStorage.getItem('cus_phone')) {
            localStorage.removeItem('cus_phone');
        }
        if (localStorage.getItem('cus_company')) {
            localStorage.removeItem('cus_company');
        }
...
<?php if ($this->input->get('customer')) {?>
        ...
        $('#payment').click(function () {
            ...
            var twt = formatDecimal((total + invoice_tax) - total_discount + shipping);
            ...
            if (total_paid < grand_total) {
                bootbox.confirm("<?=lang('paid_l_t_payable');?>", function (res) {
                    if (res == true) {
                        ...
                        $('#checkin_id').val(localStorage.getItem('checkin_id'));
                        $('#staff_note').val(localStorage.getItem('staffnote'));
                        $('#customer_name').val(localStorage.getItem('cusname'));
                        $('#customer_phone').val(localStorage.getItem('cus_phone'));
                        $('#customer_company').val(localStorage.getItem('cus_company'));
...
<script type="text/javascript">
    $(document).on('click','.floors',function(){
        ...
        $.ajax({
            type:'get',
            url:'<?php echo admin_url()?>pos/getTableByFloor',
            data:{val:val},
            dataType:'Json',
            async:false,
            success:function(result){
                console.log(result.floor_table);
                $('#brands_list').empty();
                $.each(result.floor_table,function(key,value){
                    $('#brands_list').append('<button style="height:50px !important;" type="button" id="" value="'+key+'" class=" btn-prni ltable"><span>'+value+'</span></button>');
                });
            }
        });
    });
