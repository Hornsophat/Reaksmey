...
<div id="bill_tbl">
  ...
  <div class="col-xs-12 pull-right" style="min-width:100%; min-height:3px;">
       ...
       <!-- <img style="max-width:100% !important;" src="<?php echo base_url();?>/assets/uploads/logos/invoice_head2.jpg ?>"> -->
  ...
  <table width="100%" class="prT" style="margin-bottom:0;border-top:2px dotted #000000;">
    <thead class="hide">
  ...
  <table  class="prT" style="margin-bottom:0; line-height:20px !important;border-bottom:2px dotted #000000;" width="100%">
