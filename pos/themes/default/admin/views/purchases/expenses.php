...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#EXPData').dataTable({
            ...
            {column_number: 3, filter_default_label: "[<?=lang('Expend Type');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th class="col-xs-2"><?= lang("Expend Type");?></th>
                            <th class="col-xs-2"><?= lang("Supplier Name"); ?></th>
