						...
						<tbody>
							<?php $i=0;foreach ($record as $re): $i++;?>
								<tr>
									...
									<td><?php echo $this->sma->formatDecimal($re->amount_usd) ?>(R)</td>
									<td style="width:9%"><a target="_blank" href="<?php echo site_url('admin/purchases/get_print_payment/'.$re->rec_id) ?>">View Voucher</a></td>
								</tr>
							<?php endforeach ?>
						</tbody>
						<tfoot>
