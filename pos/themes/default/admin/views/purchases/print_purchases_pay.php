                    ...
                    <tbody>
                        <?php $i=0;foreach ($voucher_detail as $vd): $i++;?>
                            ...
                            <tr>
                                ...
                                <td><?php echo number_format($vd->amount_usd/$rate->rate,2); ?>(USD)</td>
                    ...
                    <table class="table table-bordered" style="background: white !important">
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?= number_format($voucher->amount_usd/$rate->rate,2); ?>&nbsp;(USD)</td>
                                <td style="text-align:right; padding-right:10px;font-weight:bold;"><?php echo $this->sma->formatMoney($voucher->amount_usd); ?>&nbsp;(R)</td>
                            </tr>
                            <tr>
