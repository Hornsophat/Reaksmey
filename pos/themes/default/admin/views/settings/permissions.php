                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label for="purchases-expenses" class="padding05"><?= lang('list_expenses') ?></label>
                                        <input type="checkbox" value="1" id="add-purchases-expenses" class="checkbox" name="add-purchases-expenses" <?php echo $p->{'add-purchases-expenses'} ? "checked" : ''; ?>>
                                        <label for="purchases-expenses" class="padding05"><?= lang('add_expenses') ?></label>
                                        ...
                                        <input type="checkbox" value="1" id="sum_purchases_payment" class="checkbox" name="sum_purchases_payment" <?php echo $p->{'sum_purchases_payment'} ? "checked" : ''; ?>>
                                        <label for="sum_purchases_payment" class="padding05"><?= lang('add_purchases_payment') ?></label>
                                        <input type="checkbox" value="1" id="list_purchases_payment" class="checkbox" name="list_purchases_payment" <?php echo $p->{'list_purchases_payment'} ? "checked" : ''; ?>>
                                        <label for="list_purchases_payment" class="padding05"><?= lang('list_purchases_payment') ?></label>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="5">
                                        ...
                                        <span style="inline-block" class="hide">
                                         ...
                                         <span style="inline-block">
                                            ...
                                            name="register_report" <?php echo $p->{'reports-register_report'} ? "checked" : ''; ?>><label for="products" class="padding05"><?= lang('Register') ?></label>
                                        </span>
                                        <span style="inline-block">
                                        ...
                                        <span style="inline-block">
                                         ...
                                         <span style="inline-block" class="">
                                            <input type="checkbox" value="1" class="checkbox" id="user-daily_sales" name="reports-user_daily_sales" <?php echo $p->{'reports-user_daily_sales'} ? "checked" : ''; ?>>
                                            <label for="expenses" class="padding05"><?= lang('User-daily_sales') ?></label>
                                        </span>
                                        ...
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="stock_in_out_report"
                                            name="stock_in_out_report" <?php echo $p->{'reports-stock_in_out_report'} ? "checked" : ''; ?>><label for="products" class="padding05"><?= lang('Stock IN/OUt Report') ?></label>
                                        </span>
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="warehouse_chat"
                                            name="warehouse_chat" <?php echo $p->{'reports-warehouse_chat'} ? "checked" : ''; ?>><label for="products" class="padding05"><?= lang('Warehouse Chat') ?></label>
                                        </span>
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="profit_and_loss"
                                            name="profit_and_loss" <?php echo $p->{'reports-profit_and_loss'} ? "checked" : ''; ?>><label for="products" class="padding05"><?= lang('Profit and loss') ?></label>
                                        </span>
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="account_receivable"
                                            name="account_receivable" <?php echo $p->{'account_receivable'} ? "checked" : ''; ?>><label for="products" class="padding05"><?= lang('A/R Report') ?></label>
                                        </span>
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="account_payable"
                                            name="account_payable" <?php echo $p->{'account_payable'} ? "checked" : ''; ?>><label for="products" class="padding05"><?= lang('A/P Report') ?></label>
                                        </span>
