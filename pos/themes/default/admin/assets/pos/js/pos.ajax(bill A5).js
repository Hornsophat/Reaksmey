...
// ======================================================= add  new for looping row ================================================;
                ...
                bprTr += '<td style="border-right:1px solid #ddd;"> $ '+Number(parseFloat(item_price)+ parseFloat(pr_tax_val) + item_discount).toFixed(2) +'</td>';

                if(item_discount == 0) {
                    bprTr += '<td style="text-align:center !important;border-right:1px solid #ddd !important;"></td>';
                } else if((formatMoney(((parseFloat(item_price) + parseFloat(pr_tax_val)) * parseFloat(item_qty)))) == 0) {
                    bprTr += '<td style="text-align:center !important;border-right:1px solid #ddd !important;">Free</td>';
                } else {
                    bprTr += '<td style="text-align:center !important;border-right:1px solid #ddd !important;"> $ &nbsp;'+ formatDecimal(item_qty)*item_discount +'</td>';
                }
                ...
                bprTr += '<td style="text-align:right;">$ '+Number( ((parseFloat(item_price) + parseFloat(pr_tax_val)) * parseFloat(item_qty))).toFixed(2)+' &nbsp;</td></tr>';
                rows++;
...
// ======================================add new for looping row table=========================================================
        ...
        if (pos_settings.remote_printing != 1) {
            ...
            var bill_totals = '';
            bill_totals += '<tr class=" fitem"><td style="text-align:center;border-right:1px solid #ddd;border-left:1px solid #ddd;" rowspan=3>អត្រាប្តូរប្រាក់​ :'+Number(rate_cur).toFixed(2)+'(R) </br><div class="col-xs-6"><p style="font-size:11px;">អ្នកទិញ / The Buyer<hr></p></div> <div class="col-xs-6"><p style="font-size:11px;">អ្នកលក់ / The Seller<hr></p></div> </td><td style="border-right:1px solid #ddd;">សរុបដុល្លា</td><td style="font-size:11px !important;text-align:right;">$ '+Number(total).toFixed(2)+'&nbsp; </td></tr>';
            
            if(order_discount > 0 || product_discount > 0) {
                bill_totals += '<tr class=" fitem"><td style="border-right:1px solid #ddd;">បញ្ចុះតំលៃ</td><td style="font-size:11px !important;text-align:right;">$ '+Number(order_discount+product_discount).toFixed(2)+' &nbsp;</td></tr>';
            }
            if (site.settings.tax2 != 0 && invoice_tax != 0) {
                bill_totals += '<tr class=" fitem"><td>'+lang.order_tax+'</td><td style="font-size:11px !important;text-align:right;">R '+Number(invoice_tax).toFixed(2)+'&nbsp;</td></tr>';
            }
            ...
            bill_totals += '<tr class=" fitem"><td style="border-right:1px solid #ddd;">សរុបរៀល </td><td style="font-size:11px !important;text-align:right;">R '+Number(gtotal*rate_cur).toFixed(2)+' &nbsp;</td></tr>';
            if(pos_settings.rounding != 0) {
                round_total = roundNumber(gtotal, parseInt(pos_settings.rounding));
                var rounding = formatDecimal(round_total - gtotal);
                bill_totals += '<tr class=" fitem"><td>'+lang.rounding+'</td><td style="font-size:11px !important; text-align:right;border-top:1px solid #000 !important;">'+Number(rounding).toFixed(2)+' &nbsp;</td></tr>';
                bill_totals += '<tr class=" fitem"><td>'+lang.total_payable+'</td><td style="font-size:11px !important; text-align:right;border-top:1px solid #000 !important;">'+Number(round_total).toFixed(2)+' &nbsp;</td></tr>';
            }
