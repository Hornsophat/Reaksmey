...
// ======================================================= add  new for looping row ================================================;
                ...
                //     bprTr+='<tr style="page-break-after: always;"></tr>';
                    // bprTr+='<tr style="display: block; page-break-after: always;position: relative;"></tr>';
                    // bprTr+='<tr style="display: block;page-break-before: always;position: relative;"></tr>';
                // }
                 
// ======================================================= add  new for looping row ================================================;

                bprTr = '<tr style="font-size:10px;" class="row_' + item_id + '" data-item-id="' + item_id + '"><td colspan="" style="text-align:center !important;">'+ (an-1) + '</td>';               bprTr += '<td >'+ item_name +'</td>';
                bprTr += '<td style="text-align:center !important;">'+ formatDecimal(item_qty)+munit[product_unit] +'</td>';
                // bprTr += '<td > $ '+Number(parseFloat(item_price)+ parseFloat(pr_tax_val) + item_discount).toFixed(0) +'</td>';
                ...
                bprTr += '<td style="text-align:right;">$ '+Number( ((parseFloat(item_price) + parseFloat(pr_tax_val)) * parseFloat(item_qty))).toFixed(0)+'</td></tr>';
...
// ======================================add new for looping row table=========================================================
        ...
        if (pos_settings.remote_printing != 1) {
            ...
            var bill_totals = '';
            bill_totals += '<tr class=" fitem"><td style="text-align:left;border-left:1px solid #ddd;line-height:18px !important; font-size:10px !important;">Grand Totals</td><td style="font-size:10px;">$ '+Number(total).toFixed(2)+'</td><td style="font-size:10px;">R</td><td style="font-size:10px !important;text-align:right;">R '+Number(gtotal * rate_cur).toFixed(2)+'</td></tr>';
            
            if(order_discount > 0 || product_discount > 0) {
                bill_totals += '<tr class=" fitem"><td>'+lang.discount+'</td><td style="font-size:10px !important;text-align:right;">R '+Number(order_discount+product_discount).toFixed(2)+'</td></tr>';
            }
            if (site.settings.tax2 != 0 && invoice_tax != 0) {
                bill_totals += '<tr class=" fitem"><td>'+lang.order_tax+'</td><td style="font-size:10px !important;text-align:right;">R '+Number(invoice_tax).toFixed(2)+'</td></tr>';
            }
            ...
            // bill_totals += '<tr class=" fitem"><td>Grand Total  Riel</td><td style="font-size:11px !important;text-align:right;">$ '+Number(gtotal*rate_cur).toFixed(2)+'</td></tr>';
            if(pos_settings.rounding != 0) {
                round_total = roundNumber(gtotal, parseInt(pos_settings.rounding));
                var rounding = formatDecimal(round_total - gtotal);
                bill_totals += '<tr class=" fitem"><td>'+lang.rounding+'</td><td style="font-size:10px !important; text-align:right;border-top:1px solid #000 !important;">'+Number(rounding).toFixed(0)+'</td></tr>';
                bill_totals += '<tr class=" fitem"><td>'+lang.total_payable+'</td><td style="font-size:10px !important; text-align:right;border-top:1px solid #000 !important;">'+Number(round_total).toFixed(0)+'</td></tr>';
            }
