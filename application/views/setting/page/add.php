		        ...
		        <div class="panel panel-default">
		            <div class="panel-body">
		                <div class="table-responsive" id="tab_print">
		                    <form enctype="multipart/form-data" accept-charset="utf-8" method="post" id="defaultform" action='<?php echo site_url('setting/page/savepage');?>'> <table align='center' width="700">
		                        <tr>
		                            <td><label for="emailField">Page Name</label></td>
		                            <td> : </td>
		                            <td><input type='text' class="form-control" name='txtp_name' id='txtp_name' required data-parsley-required-message="Enter Page Name" placeholder="Place Page name" /> </td>
		                        ...
		                        <table id="show_action" class="table table-bordered" style="margin-top: 20px;">
		                            ...
		                            <tbody id="action_row">
		                                <!-- <tr>
											<td>
												<input type="text" class="form-control" name="page_action[]" required placeholder="Enter Page Action">
											</td>
												
											<td>
												<input type="text" class="form-control" name="page_url[]" required placeholder="Enter Page Url">
											</td>
											<td style="text-align: center;">
												<input type="checkbox" class="form-control" name="page_type[]" value="1" style="width: 20px;">
											</td>
											<th style="width: 20px;">
												<a href="javascript:void(0)" class="pull-right remove_row">
