    ...
    <div class="page-header users-header">
      <h2>
        ...
        <div class="pull-right">
          ...
          <button type="button" class="btn btn-default" id="reservation">Reservation</button>
                ...
                <div class="panel <?php echo $boxcolor; ?>">
                    ...
                    <div class="row">
                      ...
                      <?php if(count($has_checkin) > 0) { ?>
                        <div class="col-xs-12" id="reservation">
                          <div class="line-top">
                            <div>Customer : <b><?php echo $has_checkin->family; ?></b></div>
                      ...
                      <?php } else if(count($has_reservation) > 0) { ?>
                        <div class="col-xs-12" id="checkin">
                          <div class="line-top">
                            <div>Customer : <b><?php echo $has_reservation->family; ?></b></div>
                  ...
                  <div class="panel-footer">
                    <?php if(count($has_checkin) > 0) { ?>
                      ...
                      <?php } ?>
                    <?php } else if(count($has_reservation) > 0) { ?>
                      <label class="pull-left label label-default">Reservation (<?php echo $has_reservation->confirmed==1?'confirmed':'not confirmed'; ?>)</label>
