    <div class="container top">
      ...
      if(isset($flash_message)){
        if($flash_message == TRUE)
        {
          echo '<div class="alert alert-success">';
            ...
            echo '<strong>Well done!</strong> Update Success add to database';
          echo '</div>';       
        }else{
      ...
      echo form_open('admin_home/save_profile', $attributes);
      ?>
        <fieldset>
    ...
    <div class="control-group">
         ...
         <div class="col-md-3">
	  <div class="control-group">
            <label for="inputError" class="control-label">Confirm New Password</label>         
            <div class="controls">
