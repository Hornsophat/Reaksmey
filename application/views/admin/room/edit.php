    ...
    <div class="container top">
	 ...
	 <div class="col-md-3">
	  <div class="control-group">
            ...
            <div class="controls">
              <input class="form-control" type="text" id="" name="room_no" value="<?php echo $room[0]['room_no']; ?>" >
            </div>
          </div>
         </div>
	 ...
	 <div class="col-md-3">
	  <div class="form-group">
            ...
            <div class="col-sm-10">
	      	      <?php
		echo form_dropdown('type_id', $option_room_type, $room[0]['type_id'], 'class="span2 form-control" id="type_id"');
		?>
            </div>
          </div>
         </div>
	 ...
	 <div class="col-md-3">
	  <div class="control-group">
            ...
            <div class="controls">
              	<?php
		echo form_dropdown('floor', $option_floor , $room[0]['floor'], 'class="span2 form-control"');
		?>
            </div>
          </div>
         </div>          
