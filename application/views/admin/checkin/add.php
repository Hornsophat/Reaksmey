            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input class="form-control " type="text" id="Passport" name="Passport" value="<?php echo set_value('Passport'); ?>" readonly >
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input class="form-control " type="text" id="Gender" name="Gender" value="<?php echo set_value('sex'); ?>" readonly>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <?php if($roomtype OR $roomid) {
                      echo '<select name="room_no" class="span2 form-control chosen room_ajax" id="room_no" readonly>';
                      ...
                      echo form_dropdown('room_no', $option_free_rooms, set_value('room_no', $roomid), 'class="span2 form-control chosen room_ajax" id="room_no"');
                    } ?>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input class="form-control" onclick="this.select();" type="text" id="duration" name="duration" value="0"  oninput = "this.value=this.value.replace(/[^0-9.]/g,'');">
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <input class="form-control " type="text" id="Price" name="Price" value="<?=isset($is_roomtype) ? $is_roomtype->price : '0';?>" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <input class="form-control" onclick="this.select();" type="text" id="discount_re" name="discount" value="0"  oninput = "this.value=this.value.replace(/[^0-9.%]/g,'');">
                      </div>
                    </div>
                  </div>
...
// admin/checkin/total_checkin
  ...
  function total_checkin(){
      ...
      if(room_no == '' || room_no == null){
        ...
        $.ajax({
          type : 'POST',
          url  : '<?php echo site_url();?>admin/checkin/total_checkin',
