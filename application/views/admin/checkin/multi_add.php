...
<div class="container top">
  ...
  echo form_open('admin/checkin/multi_add', $attributes); 
  ?>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input class="form-control " type="text" id="Family" name="Family" value="<?php echo set_value('Family'); ?>" readonly>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input class="form-control " type="text" id="Passport" name="Passport" value="<?php echo set_value('Passport'); ?>" >
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input class="form-control " type="text" id="Gender" name="Gender" value="<?php echo set_value('sex'); ?>"  >
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
              <div class="row">
                 <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input class="form-control" type="text" onclick="this.select();"  oninput = "this.value=this.value.replace(/[^0-9]/g,'');" id="duration" name="duration" value="0">
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      ...
                      <?php foreach ($banks as $name => $bank_name): ?>
                        <option value="<?=$bank_name->id?>"> <?=$bank_name->account_name?> </option>
                      <?php endforeach ?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input class="form-control" type="text" id="bank_amount" name="bank_amount" value="0">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <input class="form-control" onclick="this.select();"  type="text" id="discount" name="discount" value="0" oninput = "this.value=this.value.replace(/[^0-9.%]/g,'');">
                    </div>
                  </div>
                </div>
               <div class="col-md-12">
                ...
                <div class="col-md-12">
                 ...
                 <div class="col-md-12">
                  <div class="form-group">
                    <label for="inputError" class="control-label">Bank Note</label>
                    <div class="col-sm-12">
          ...
          <div class="panel-heading"><?php echo lang('Room Information');?></div>
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <?php 
                    if($roomtype) {
                      $data = 'class="span2 form-control" id="roomtype" readonly'; 
                    } else {
                      $data = 'class="span2 form-control" id="roomtype"';
                    } ?>
           ...
           <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <?php if($roomtype OR $roomid) {

                      echo '<select name="room_no" class="span2 form-control" id="room_no" readonly>';

                      $result = $this->room_model->get_by_type($roomtype);
                      foreach($result as $item) {

                        echo '<option value="'.$item['id'].'" ';
                        echo $item['id']==$roomid?'selected':'';
                        echo '>'.$item['room_no'].'</option>';
                      }
                      echo '</select>';
                    } else {
                      echo form_dropdown('room_no', $option_free_rooms, set_value('room_no', $roomid), 'class="span2 form-control" id="room_no"');
                    } ?>
                    <input type="hidden" name="roomnumber" value="<?php echo $roomid ? $roomid : '0'; ?>">                    
                  </div>
                </div>
              </div>
            <div class="panel-body">
            ...
            <thead>
              <tr>
                ...
                <th class="yellow header headerSortDown" style="text-align:center;width: 12rem;"><?php echo lang('Floor');?></th>
                <th class="yellow header headerSortDown" style="text-align:center; width: 12rem;"><?php echo lang('CheckIn Type');?></th>
                ...
                <th class="yellow header headerSortDown"><?php echo lang('Price');?></th>
                 <th class="yellow header headerSortDown" style="text-align:center;width: 12rem;"><?php echo lang('amount');?></th>
  ...
  <div class="form-actions" style="margin-bottom: 10px;">
    <button class="btn btn-primary" type="submit" id="write_card"><?php echo lang('Save changes');?></button>
    <button class="btn " type="reset"><?php echo lang('Cancel');?></button>
  </div>
</div>
</div>
