        ...
        <div id="receiptData">
            ...
            <div id="receipt-data">
                <div class="text-center" style="text-align: center; clear: both; padding-bottom:0px;margin-top:22px">
                   <div style="margin-left:78px"> <img class="" src="<?php echo site_url('assets/images/domnakneak3.png'); ?>" alt="Palm River Hotel" style=' float: left; clear: both;margin-top:-20px;border-radius: 10px;'></div>
                   <br><br><br><br><br>
