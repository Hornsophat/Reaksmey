...
class Admin_currencies extends CI_Controller {
    ...
    */
    ...
    function exspanse_type_insert(){
        ...
        if ($re) {
            redirect('admin_currencies/expense_list');
        }else{
            redirect('admin_currencies/expense_list');
        }
    }
    ...
    function exspanse_insert(){
        ...
        if ($this->form_validation->run() == false) {
            redirect('admin_currencies/add_exspanse');
        }else{
            $exp_arr=array(
    ...
    function add_bank(){
      ...
      function delete_bank($id){
        $id = $this->uri->segment(3);
        $this->currencies_model->delete_ba($id);
        redirect('admin_currencies/add_bank');
    }
    function getAllBank(){
